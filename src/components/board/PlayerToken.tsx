...
export default function PlayerToken({ name, color, index, isInJail, offset = 0, totalAtSpot = 1 }: PlayerTokenProps) {
    ...
    const JailBars = isInJail && (
        <Box sx={{
            ...
            borderRadius: '50%',
            background: 'repeating-linear-gradient(90deg, transparent, transparent 4px, rgba(0,0,0,0.6) 4px, rgba(0,0,0,0.6) 6px)',
            pointerEvents: 'none'
        }} />
    );
